...
public class Passenger extends Person {
     ...
     * This method assigns a random email, name, phone number, and user ID to the
     * passenger.
     * 
     */
    @Override
     ...
     */
    @Override
    public void update(String field, String newValue) throws InvalidEmailException {
        ...
        switch (field) {
            case "name":
                ...
                break;
            case "email":
                if (!newValue.matches("^[\\w\\d][\\w\\d-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$")) {
                    throw new InvalidEmailException("Invalid email: " + newValue);
                }
                this.email = newValue;
                break;
            case "phone":
