...
public class Vehicle {
     ...
     * This method assigns a random ID, registration number, model and year to the
     * vehicle.
     */
     ...
     *                 is not updated.
     */
    public void updateVehicle(String field, String newValue) throws TimeTravelException{
        ...
        switch (field) {
            ...
            case "model":
                ...
                break;
            case "year":
                if (Integer.valueOf(newValue) > Integer.valueOf(LocalDateTime.now().getYear())) {
                    throw new TimeTravelException("Go back to the year: " + newValue);
                }
