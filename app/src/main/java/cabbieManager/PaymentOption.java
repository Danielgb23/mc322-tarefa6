...
public enum PaymentOption {
    ...
    /**
     * Returns the PaymentOption corresponding to the given name, or null if none is
     * found.
     * 
    ...
    float calculatePaymentFee(float value) throws InvalidFeeException{
        float amount = value * fee;
        if (amount <= 0) {

            throw new InvalidFeeException("Invalid payment fee: " + amount);
        }
        return amount;
    }
